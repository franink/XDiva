...
%             end
            ...
            if save_params
                ...
                tmp_params.numeroRef = numeroRef;
                tmp_params.shapeRef = shapeRef;
                tmp_params.rMax = rMax;
                tmp_params.Area_params = imgAreaList;
                tmp_params.ItemSize_params = imgSizeList;
                tmp_params.lumIdx = lumIdx;
                for i=1:length(imgSeq)
                    if imgSeq(i) ~= 0
                        tmp_params.imgs = img(:,:,1,imgSeq(i));
                    else
                    end
                end
